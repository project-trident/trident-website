...
* The Lumina PDF viewer has had a few significant changes:
   1. It uses the "poppler" libraries for rendering PDF files once again. The "mupdf" backend has been switched off by default because a recent version update to mupdf has completely change the mupdf library APIs.
